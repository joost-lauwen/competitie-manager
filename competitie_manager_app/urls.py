...
urlpatterns = [
    ...
    path('teams/',
         views.team_list_view.TeamListView.as_view(),
         name='teams_list'),
    path('<competitie>/wedstrijden',
         views.match_list_view.MatchListView.as_view(),
         name='matches'),
    path('wedstrijden',
         views.matches_all_list_view.MatchAllListView.as_view(),
         name='matches_all'),
    ...
    path('<competitie>/wedstrijden/<int:match_pk>/weddenschap_invullen',
         ...
         name='bet_create'),
    path('mijn_weddenschappen/',
         views.bet_list_view.BetListView.as_view(),
         name='bet_list'),
    path('<competitie>/wedstrijden/<int:match_pk>/weddenschap/<int:pk>',
         views.bet_detail_view.BetDetailView.as_view(),
         name='bet_detail'),
    path('dashboard',
         views.user_dashboard_view.UserDashboardView.as_view(),
         name='user_dashboard')
]
